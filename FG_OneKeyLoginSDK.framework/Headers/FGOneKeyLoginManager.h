...
@protocol FGOneKeyLoginManagerDelegate <NSObject>
...
- (void)clFGSDKManagerAuthPageAfterViewDidLoad:(UIView *_Nonnull)authPageView
...
-   (void)clFGSDKManagerAuthPageCompleteViewDidLoad:(UIViewController *_Nonnull)authPageVC
                                          currentTelecom:(NSString *_Nullable)telecom
...
/// @param object           授权页相关内容信息
/// @param userInfo         授权页相关UI控件字典，用法见demo
- (void)clFGSDKManagerAuthPageCompleteViewWillAppear:(UIViewController *_Nonnull)authPageVC
                                           currentTelecom:(NSString *_Nullable)telecom
                                                   object:(NSObject *_Nullable)object
                                                 userInfo:(NSDictionary *_Nullable)userInfo;
...
/// @param object           授权页相关内容信息
/// @param userInfo         授权页相关UI控件字典，用法见demo
- (void)clFGSDKManagerAuthPageCompleteInit:(UIViewController *_Nonnull)authPageVC
                                 currentTelecom:(NSString *_Nullable)telecom
                                         object:(NSObject*_Nullable)object
                                       userInfo:(NSDictionary*_Nullable)userInfo;
...
/// @param object           授权页相关内容信息
/// @param userInfo         授权页相关UI控件字典，用法见demo
- (void)clFGSDKManagerAuthPageWillPresent:(UIViewController *_Nonnull)authPageVC
                                currentTelecom:(NSString *_Nullable)telecom
                                        object:(NSObject *_Nullable)object
                                      userInfo:(NSDictionary *_Nullable)userInfo;
...
- (void)clFGActionListener:(NSInteger)type
                           code:(NSInteger)code
...
- (void)clFGPrivacyListener:(NSString *_Nonnull)privacyName
...
@interface FGOneKeyLoginManager : NSObject<CLShanYanSDKManagerDelegate>

@property (nonatomic,weak) id<FGOneKeyLoginManagerDelegate> delegate;
